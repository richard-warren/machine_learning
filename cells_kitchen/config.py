"""
TODO:
work on summary imgs: catch all APs // make look similar across vids...
...
filters = 64  # seemed to work with as little as 16 // 8 was a little blurrier, which is encouraging...
